...
(function(document) {
    ...
    MBP.startupImage = function() {
        ...
        if (navigator.platform === 'iPad') {
            portrait = pixelRatio === 2 ? 'img/startup-tablet-portrait-retina.png' : 'img/startup-tablet-portrait.png';
            landscape = pixelRatio === 2 ? 'img/startup-tablet-landscape-retina.png' : 'img/startup-tablet-landscape.png';
            ...
            portrait = pixelRatio === 2 ? "img/startup-retina.png" : "img/startup.png";
            portrait = screen.height === 568 ? "img/startup-retina-4in.png" : portrait;
            link1 = document.createElement('link');
            link1.setAttribute('rel', 'apple-touch-startup-image');
            link1.setAttribute('href', portrait);
            head.appendChild(link1);
