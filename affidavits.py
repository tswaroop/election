...
affidavits['STATE'] = affidavits.apply(lambda row: pc.ix[row['ST_CODE'], row['PC_CODE']]['STATE'], axis=1)
affidavits['PC'] = affidavits.apply(lambda row: pc.ix[row['ST_CODE'], row['PC_CODE']]['PC'], axis=1)
